...
The core utilities, input projection, positional encoding, feed-forward math,
and LayerNorm are implemented and behaviorally tested. Data loading, attention,
encoder orchestration, artifact loading, the prediction head, and the CLI remain
